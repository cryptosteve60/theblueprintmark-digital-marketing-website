...
const LogoMark = ({ size = 28 }: { size?: number }) => (
  ...
  >
    {/* Hex blueprint badge */}
    <path
      d="M16 1.5 L28.99 9 V23 L16 30.5 L3.01 23 V9 Z"
      fill="#0a1430"
      stroke={BRAND}
      strokeWidth="1.5"
      strokeLinejoin="round"
    />
    {/* Inner hex outline (blueprint feel) */}
    <path
      d="M16 5.5 L25.53 11 V21 L16 26.5 L6.47 21 V11 Z"
      fill="none"
      stroke={BRAND}
      strokeOpacity="0.35"
      strokeWidth="0.75"
    ...
    {/* Accent dot */}
    <circle cx="26.5" cy="6" r="1.4" fill={BRAND} />
  </svg>
);
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <span className="md:hidden" style={{ display: "inline-flex", alignItems: "center" }}>
              <LogoMark size={26} />
            </span>
            <span
              style={{
