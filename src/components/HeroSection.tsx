    ...
    <section className="hero-gradient min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto text-center relative z-10">
        <div className="flex justify-center items-center gap-2 mb-4">
          ...
          <span className="text-accent font-semibold text-sm">Digital Marketing Excellence</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          <div className="card-gradient p-4 rounded-xl border border-primary/20 hover-lift transition-all duration-300">
            <TrendingUp className="h-6 w-6 text-primary mb-3 mx-auto" aria-hidden="true" />
            <h3 className="text-lg font-semibold mb-2">ROI Focused</h3>
            <p className="text-muted-foreground text-sm">Every strategy designed for maximum return on investment</p>
          </div>
          
          <div className="card-gradient p-4 rounded-xl border border-secondary/20 hover-lift transition-all duration-300">
            <Zap className="h-6 w-6 text-secondary mb-3 mx-auto" aria-hidden="true" />
            <h3 className="text-lg font-semibold mb-2">Lightning Fast</h3>
            <p className="text-muted-foreground text-sm">Rapid implementation and quick results delivery</p>
          </div>
          
          <div className="card-gradient p-4 rounded-xl border border-accent/20 hover-lift transition-all duration-300">
            <ArrowRight className="h-6 w-6 text-accent mb-3 mx-auto" aria-hidden="true" />
            <h3 className="text-lg font-semibold mb-2">Growth Driven</h3>
            <p className="text-muted-foreground text-sm">Sustainable growth strategies that scale with your business</p>
          </div>
        </div>
      </div>
    </section>
